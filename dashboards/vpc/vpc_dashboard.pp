dashboard "vpc_dashboard" {
  ...
  container {
    ...
    chart {
      ...
      type  = "donut"
      width = 3
      query = query.vpc_default_status
  ...
  container {
    ...
    chart {
      ...
      query = query.vpc_by_rfc1918_range
      type  = "column"
      width = 3
    }
